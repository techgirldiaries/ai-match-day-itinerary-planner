...
import type { FanType, IntakeFormData, TravelStyle } from "@/core/types";
...
export function formatIntakeMessage(data: IntakeFormData): string {
	...
	const fanTypeLabels: Record<FanType, string> = {
		loyal_hatter: "Loyal Hatter",
		kenilworth_road_faithful: "Kenilworth Road Faithful",
		supporters_trust_owner: "Supporters Trust Owner",
		international_modern: "International Modern",
		away_day_specialists: "Away Day Specialist",
		multicultural_town: "Multicultural Town",
		men_in_gear: "Men in Gear",
		other: "Other",
	};
